...
process.stdin.on("data", (data) => {
	...
	if (args[0] === "bot.Data.view") {
	  ...
	  console.log(`[Data/Username] ${usernameData[id]}`)
	  console.log(`[Data/likesData] ${likesData[`${id}_likes`]} likes`)
	  console.log(`[Data/likesData] ${likesData[`${id}_liked`]} liked`)
	  console.log(`[Data/ProfileData] ${profileData[`${id}_color`]}`)
	  console.log(`[Data/ProfileData] ${profileData[`${id}_desc`]}`)
	  console.log(`[Data/ProfileData] ${profileData[`${id}_url`]}`)
	  console.log(`[Data/ProfileData] ${profileData[`${id}_icon`]}`)
	  console.log(`[Data/ProfileData] ${profileData[`${id}_footer`]}`)
	  console.log(`[Data/ProfileData] ${profileData[`${id}_ficon`]}`)
	}
  });
